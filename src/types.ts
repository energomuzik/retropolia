...
export interface CellDef {
  ...
  nextTag?: 'in' | 'out'; // метка закоулка: «вход» = начало круга (с этой ячейки фишка сворачивает в него), «выход» = конец (ячейка, куда круг приводит; дальше — обычная нумерация). Ячейки МЕЖДУ ними — без номеров
...
export const APP_VERSION = 13; // 13: закоулки пошагово: фишка ходит по стрелкам по одной клетке за шаг кубика, без протаскивания до выхода; без номера — ячейки МЕЖДУ «входом» и «выходом»
