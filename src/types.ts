...
export interface CellDef {
  ...
  nextTag?: 'in' | 'out'; // метка закоулка: «вход» = стрелка ведёт В круг (фишка на этой ячейке проваливается в круг), «выход» = стрелка из последней ячейки круга наружу
...
export const APP_VERSION = 12; // 12: закоулки-ловушки: круг вне нумерации, вход протаскивает фишку по кругу до выхода
