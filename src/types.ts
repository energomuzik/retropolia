...
export interface GameMap {
  ...
  mapTokens?: TokenDef[]; // фишки партии (до 8): автор карты выбирает в редакторе, они вшиты в карту и уезжают всем игрокам; после жеребьёвки каждый игрок выбирает себе одну — одинаковые нельзя
...
export const APP_VERSION = 18; // 18: размер фишки (дефолт = размер тайла), непрерывный плавный ход без остановок у клеток, зеркало тайлов (карта + кадры анимаций), до 8 фишек на карту; старые партии не продолжаются
