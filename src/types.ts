...
export const APP_VERSION = 27; // 27: ФОН НА КАЖДУЮ ПЛИТКУ — в редакторе при разбивке на плитки выбор «На эту плитку / На всю карту»: у каждой плитки своя картинка («другая локация»), одна на всё поле тоже осталась; свои фоны плиток рисуются поверх общего фона карты
