...
/* Оформление стрелки на карте: толщина, цвет, пунктир, наконечник-остриё.
   Всё необязательно: по умолчанию — жирная (6px) сплошная с остриём, стандартного цвета. */
export interface ArrowStyle {
  w?: number;     // толщина линии в px (по умолчанию 6)
...
export const APP_VERSION = 15; // 15: новый тип ячейки «передышка», настраиваемые стрелки (толщина/цвет/пунктир/наконечник), из ловушек убраны сдвиг/телепорт/«не туда» — перемещения только стрелками; старые партии не продолжаются
