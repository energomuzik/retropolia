...
export const APP_VERSION = 19; // 19: скорость хода фишек задаёт автор карты (клеток/с, для «плавно» и «прыжками»), камера плотнее держит фишку, фишек до 12, тайлы в фишки выбираются с левой панели (+ группа «Изменённые»), ПКМ без меню браузера; старые партии не продолжаются
