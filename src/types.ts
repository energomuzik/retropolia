...
export const APP_VERSION = 26; // 26: покачивание фишки убрано полностью (и в пути, оба режима хода); БОЛЬШИЕ КАРТЫ — поле до 16384×16384 px, ПЛИТКИ (разбивка поля на страницы 1024/2048/4096 px, соседние стыкуются краями — переход ходьбой) и ПОРТАЛЫ (зона входа + точка перехода, мгновенный телепорт в JOURNEY, навигатор плиток в редакторе)
