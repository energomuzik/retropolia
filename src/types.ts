...
export const APP_VERSION = 14; // 14: закоулки по-настоящему: безномерные ячейки вне основного пути, стрелка = дорога/прыжок при остановке, вторая стрелка «переход» — выход из круга; правила движения изменились — старые партии не продолжаются
