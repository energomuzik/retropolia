...
export type QuestGoalKind = 'boss' | 'tasks' | 'coins' | 'hp' | 'time' | 'tries' | 'deliver' | 'none';
...
export interface QuestGoal {
  ...
  count?: number;           // 'tasks' — сколько заданий; 'coins' — бронзы; 'hp' — % HP; 'time' — секунд; 'tries' — попыток; 'deliver' — сколько принести
