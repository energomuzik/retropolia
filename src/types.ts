...
export const APP_VERSION = 23; // 23: слои карты (фон — низ, тайловые слои 2..6 с выбором в левой панели, ячейки/стрелки — всегда верх), «Слой ±» двигает тайл МЕЖДУ слоями, Delete-клавиша и кнопки «Удалить» в панелях тайла/анимации подчиняются режиму удаления и отменяются Ctrl+Z; ластик как был — сразу; папки ромов создаются кнопкой, ромы загружаются сразу пачкой в выбранную папку
