...
export interface CellDef {
  ...
  nextTag?: 'in' | 'out'; // метка стрелки: «вход в закуток» / «выход из закутка» — для наглядности на карте
...
export const APP_VERSION = 11; // 11: спойлеры палитры, экстрактор тайлов, метки стрелок вход/выход
