...
export interface GameMap {
  ...
  zoneSec?: number; // RUBG: ПОЛНОЕ время безопасной зоны (все ожидания + сжатия) в СЕКУНДАХ; нет — 600 (10 мин). Настраивается в редакторе карт: минуты и секунды
